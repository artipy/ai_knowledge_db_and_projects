...
**Количество заметок:** 8 основных (3 OpenAI API, 2 Prompt Engineering, 1 Local LLM, 2 Python for AI)
**Количество заданий:** 4 (задания 01-03 с решениями и ревью, задание 04 - новое)
