...
- [[OpenAI_API/Structuring_End_to_End_Applications|Структурирование end-to-end приложений]] - практическое применение retry, батчинга и обработки ошибок в production
