...
После выполнения этого задания рекомендуется перейти к [[Exercises/06_Prompt_Engineering_for_Chatbots_Exercise|Практическому заданию №6]], которое учит применять техники промпт-инжиниринга для создания специализированных чатботов с правильной настройкой роли, поведения и включением внешнего контекста.
