...
**Количество заметок:** 10 основных (3 OpenAI API, 4 Prompt Engineering, 1 Local LLM, 2 Python for AI)
**Количество заданий:** 5 (все задания 01-05 с решениями и детальными ревью)
