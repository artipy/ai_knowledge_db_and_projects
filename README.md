...
**Количество заметок:** 9 основных (3 OpenAI API, 3 Prompt Engineering, 1 Local LLM, 2 Python for AI)
**Количество заданий:** 4 (все задания 01-04 с решениями и детальными ревью)
