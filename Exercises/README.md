...
В поддиректории `Solves/` хранятся:
- `##_Topic_Name_Solve.ipynb` - решения заданий в формате Jupyter notebook
- `##_Topic_Name_Review.md` - детальные разборы решений с оценками и рекомендациями
